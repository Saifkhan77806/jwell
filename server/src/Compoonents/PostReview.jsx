...
function PostReview() {
  ...
  const postrev = () => {
    ...
    api.post('/post-review', { email: user?.userData?.profile, name: user?.userData?.name, rates: data.rates, message: data.text }).then((res) => {
  ...
  return (
    <>
      <Helmet>
        <title>Share Your Feedback with Jeweality</title>
        <meta name='description' content="We value your input! Share your thoughts and experiences by posting a review of Jeweality. Help us improve our platform and inspire others with your creative journey in jewelry design." />
      </Helmet>
